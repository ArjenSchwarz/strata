...
func TestAnalyzeOutputChange(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:       "structured AfterUnknown map with true entry",
			outputName: "object_output",
			change: &tfjson.Change{
				Actions:      []tfjson.Action{tfjson.ActionCreate},
				Before:       nil,
				After:        map[string]any{"id": nil, "name": "known"},
				AfterUnknown: map[string]any{"id": true, "name": false},
			},
			expectedOutput: &OutputChange{
				Name:       "object_output",
				ChangeType: ChangeTypeCreate,
			...
			expectedError: false,
			description:   "Structured AfterUnknown map with true entries should be detected as unknown (T-379)",
		},
		{
			name:       "structured AfterUnknown map all false",
			outputName: "known_object",
			change: &tfjson.Change{
				Actions:      []tfjson.Action{tfjson.ActionCreate},
				Before:       nil,
				After:        map[string]any{"name": "known"},
				AfterUnknown: map[string]any{"name": false},
			},
			expectedOutput: &OutputChange{
				Name:       "known_object",
				ChangeType: ChangeTypeCreate,
			...
			expectedError: false,
			description:   "Structured AfterUnknown map with all false should not be marked unknown (T-379)",
		},
		{
			name:       "nested structured AfterUnknown",
			outputName: "nested_output",
			change: &tfjson.Change{
				Actions:      []tfjson.Action{tfjson.ActionCreate},
				Before:       nil,
				After:        map[string]any{"inner": map[string]any{"id": nil}},
				AfterUnknown: map[string]any{"inner": map[string]any{"id": true}},
			},
			expectedOutput: &OutputChange{
				Name:       "nested_output",
				ChangeType: ChangeTypeCreate,
			...
			expectedError: false,
			description:   "Nested structured AfterUnknown should be detected as unknown (T-379)",
		},
		{
			name:       "structured AfterUnknown slice with true entry",
			outputName: "list_output",
			change: &tfjson.Change{
				Actions:      []tfjson.Action{tfjson.ActionCreate},
				Before:       nil,
				After:        []any{"known", nil},
				AfterUnknown: []any{false, true},
			},
			expectedOutput: &OutputChange{
				Name:       "list_output",
				ChangeType: ChangeTypeCreate,
			...
			expectedError: false,
			description:   "Structured AfterUnknown slice with true entries should be detected as unknown (T-379)",
		},
	}
