...
func TestFileOutputError(t *testing.T) {
	t.Run("error without cause", func(t *testing.T) {
		...
		expected := "validation error for /test/path: test error"
	...
	t.Run("error with cause", func(t *testing.T) {
		...
		expected := "permission error for /test/path: cannot access file (caused by: file does not exist)"
		if err.Error() != expected {
			t.Errorf("Error() = %v, want %v", err.Error(), expected)
		}
	})
...
// 		},
// 		{
// 			name: "absolute_sensitive_unix",
// 			path: "/etc/passwd",
// 			desc: "Direct absolute path to sensitive Unix file",
// 		},
// 		{
// 			name: "absolute_sensitive_proc",
// 			path: "/proc/version",
// 			desc: "Direct absolute path to /proc filesystem",
// 		},
// 		{
// 			name: "absolute_sensitive_windows",
// 			path: "C:\\Windows\\System32\\config\\SAM",
// 			desc: "Direct absolute path to Windows SAM file",
// 		},
// 		{
...
// 			expectWarn:  false,        // Won't reach overwrite check due to path validation
// 			description: "System files should be blocked by path validation",
// 		},
// 	}
...
// 				if !strings.Contains(strings.ToLower(warningMsg), "overwrite") {
...
// 			name: "windows_sam",
// 			path: "C:\\Windows\\System32\\config\\SAM",
// 			desc: "Windows Security Account Manager",
// 		},
// 		{
// 			name: "windows_system",
// 			path: "C:\\Windows\\System32\\config\\SYSTEM",
// 			desc: "Windows system registry",
// 		},
// 		{
// 			name: "boot_ini",
// 			path: "C:\\boot.ini",
// 			desc: "Windows boot configuration",
// 		},
// 		{
